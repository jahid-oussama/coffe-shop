...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm bg-light fixed-top">
        ...
        <span class="ml-3 font-weight-bold">FOOD</apan>
        ...
        <li class="nav-item"> <a class="nav-link" href="{{ route('login')}}">
          <i class="fa-solid fa-door-open"></i><span class="d-lg-none ml-3">login</span>
        </a> </li>
                       ...
                       <div class="col-md-3">
                         <div class="wsk-cp-product">
                           <div class="wsk-cp-img">
                             <img src="{{ asset("/uploads/$product->image") }}" alt="Product" class="img-responsive" />
                           </div>
                           <div class="wsk-cp-text">
                             ...
                             <div class="card-footer">
                               <div class="wcf-left"><span class="price">£{{$product->prix}}.00</span></div>
